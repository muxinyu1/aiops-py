package aiops.tracesmoke.apollo_apollo_adminservice;
...
@SpringBootApplication(
    scanBasePackages = {"com.ctrip.framework.apollo.adminservice.tracing", "com.ctrip.framework.apollo.adminservice.tracesmoke"},
    excludeName = {
