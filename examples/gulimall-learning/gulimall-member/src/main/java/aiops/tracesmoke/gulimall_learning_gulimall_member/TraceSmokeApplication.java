package aiops.tracesmoke.gulimall_learning_gulimall_member;
...
@SpringBootApplication(
    scanBasePackages = {"io.niceseason.gulimall.member.tracing", "io.niceseason.gulimall.member.tracesmoke"},
    excludeName = {
