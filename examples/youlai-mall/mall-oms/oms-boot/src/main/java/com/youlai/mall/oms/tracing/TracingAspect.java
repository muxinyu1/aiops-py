package com.youlai.mall.oms.tracing;
...
public class TracingAspect {
    ...
    @Around("(" +
            "execution(* com.youlai.mall.oms..controller..*(..)) || " +
            "execution(* com.youlai.mall.oms..controllers..*(..)) || " +
            "execution(* com.youlai.mall.oms..rest..*(..)) || " +
            "execution(* com.youlai.mall.oms..restapi..*(..)) || " +
            "execution(* com.youlai.mall.oms..endpoint..*(..)) || " +
            "execution(* com.youlai.mall.oms..service..*(..)) || " +
            "execution(* com.youlai.mall.oms..biz..*(..)) || " +
            "execution(* com.youlai.mall.oms..manager..*(..)) || " +
            "execution(* com.youlai.mall.oms.tracesmoke.TraceSmokeService.*(..))" +
            ") && " +
            "!within(com.youlai.mall.oms.tracing..*) && " +
            "!within(com.youlai.mall.oms.tracesmoke.TraceSmokeFilter) && " +
            "!within(com.youlai.mall.oms.tracesmoke.TraceSmokeController)")
