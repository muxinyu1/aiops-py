...
public class OmsOrderController {
    ...
    public Result getOrderDetail(
            @Parameter(name ="订单ID") @PathVariable String orderId
    ) {
        ...
        List<OmsOrderItem> orderItems = orderItemService.list(new LambdaQueryWrapper<OmsOrderItem>()
                ...
                .select(
                        ...
                        OmsOrderItem::getSkuSn,
                        OmsOrderItem::getSkuName,
                        OmsOrderItem::getPicUrl,
                        OmsOrderItem::getPrice,
                        OmsOrderItem::getQuantity,
                        OmsOrderItem::getTotalAmount,
                        OmsOrderItem::getCreateTime,
                        OmsOrderItem::getQuantity
                )
